<template>
    <!--<Weather Info />-->
    <div
        class="bg-gradient-to-br from-purple-600 via-blue-500 to-teal-400 p-4 m-5 rounded-2xl shadow-lg max-w-full min-h-[300px]">
            ...
            <div class="bg-black/20 backdrop-blur-sm rounded-3xl p-6">
                ...
                <div class="mb-6">
                    ...
                    <div v-if="error && !isLoading"
                        class="bg-red-500/20 text-white p-3 rounded-lg border border-red-500/30 text-sm">
                        <p>{{ error }}</p>
                    </div>

                    <!-- Loading Indicator -->
                    <div v-if="isLoading"
                        class="bg-blue-500/20 text-white p-3 max-w-xl hidden rounded-lg border border-blue-500/30 text-sm">
